...
require (
	buf.build/gen/go/accrescent/console-api/grpc/go v1.6.1-20260219033837-64def0185a8e.1 // indirect
	buf.build/gen/go/accrescent/console-api/protocolbuffers/go v1.36.11-20260219033837-64def0185a8e.1 // indirect
